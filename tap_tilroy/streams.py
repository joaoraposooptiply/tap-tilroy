            ...
            th.ArrayType(
                th.ObjectType(
                    ...
                    th.Property(
                        "order",
                        th.ObjectType(
                            th.Property("standardPrice", th.NumberType, required=False),
                            th.Property("sellPrice", th.NumberType, required=False),
                            th.Property("quantity", th.IntegerType, required=False),
                            th.Property("discount", th.NumberType, required=False),
                            th.Property("discountType", th.IntegerType, required=False),
                            th.Property("idDiscountReason", th.IntegerType, required=False),
                            th.Property("idSku", th.CustomType({"type": ["string", "number", "null"]}), required=False),
                            th.Property("rrp", th.NumberType, required=False),
                    ...
                    th.Property(
                        "shipment",
                        th.ObjectType(
                            th.Property("shipmentId", th.CustomType({"type": ["string", "null"]}), required=False),
                            th.Property("shipmentReference", th.CustomType({"type": ["string", "null"]}), required=False),
                            th.Property("shipmentExpiryDate", th.CustomType({"type": ["string", "null"]}), required=False),
                        ),
                        required=False,
                    ),
                    ...
                    th.Property(
                        "wac",
                        th.ObjectType(
                            th.Property("wac", th.NumberType, required=False),
                        ),
                        required=False,
                    ),
