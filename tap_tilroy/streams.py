...
class PurchaseOrdersStream(DynamicRoutingStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("prices.tenantCurrency.standardUnitVatExc", th.IntegerType()),
        th.Property("prices.tenantCurrency.unitVatExc", th.IntegerType()),
        th.Property("prices.tenantCurrency.standardUnitVatInc", th.IntegerType()),
        th.Property("prices.tenantCurrency.unitVatInc", th.IntegerType()),
        th.Property("prices.tenantCurrency.vat", th.IntegerType()),
        th.Property("prices.tenantCurrency.standardVatExc", th.IntegerType()),
        th.Property("prices.tenantCurrency.standardVatInc", th.IntegerType()),
        th.Property("prices.tenantCurrency.vatExc", th.IntegerType()),
        th.Property("prices.tenantCurrency.vatInc", th.IntegerType()),
        th.Property("prices.supplierCurrency.standardUnitVatExc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.unitVatExc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.standardUnitVatInc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.unitVatInc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.vat", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.standardVatExc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.standardVatInc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.vatExc", th.CustomType({"type": ["string", "integer"]})),
        th.Property("prices.supplierCurrency.vatInc", th.CustomType({"type": ["string", "integer"]})),
