...
class PurchaseOrdersStream(DynamicRoutingStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("prices.supplierCurrency.standardUnitVatExc", th.IntegerType()),
        th.Property("prices.supplierCurrency.unitVatExc", th.StringType()),
        th.Property("prices.supplierCurrency.standardUnitVatInc", th.IntegerType()),
        th.Property("prices.supplierCurrency.unitVatInc", th.StringType()),
        th.Property("prices.supplierCurrency.vat", th.StringType()),
        th.Property("prices.supplierCurrency.standardVatExc", th.IntegerType()),
        th.Property("prices.supplierCurrency.standardVatInc", th.IntegerType()),
        th.Property("prices.supplierCurrency.vatExc", th.StringType()),
        th.Property("prices.supplierCurrency.vatInc", th.StringType()),
